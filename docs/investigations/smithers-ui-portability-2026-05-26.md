...
- `src/smithersProject/cli.ts` already abstracts Smithers run command resolution across project-local, workflow-pack-local, and `bunx smthrs` fallback (`src/smithersProject/cli.ts:8-39`). That belongs in a reusable Smithers adapter layer.
