...
- `/Users/ben/code/agents/smithers/code-review/.smithers/node_modules/@smthrs/graph/src/extract.js`: task `raw.meta` is preserved into `TaskDescriptor.meta`; this is the Smithers primitive that makes `meta.editor` viable.
